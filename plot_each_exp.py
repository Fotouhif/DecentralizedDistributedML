...
def plot_results(graph_type, n_agent, datashuffle, dataset, model_name,list_experiments,type_of_plot,plot_upper_bound,moving_avg_win):
	...
	experiment_name = {'CDSGD':'CDSGD', 'LGA' : 'LGA', 'SGP' : 'SGP', 'SwarmSGD' : 'SwarmSGD', 'CDMSGD':'CDMSGD', 'CompLGA' : 'CompLGA', 'DSMA': 'DSMA'}
	...
	n_agent_name = str(n_agent)+'_agents_all'
	...
	if 1 in type_of_plot:
		...
		plt.ylabel("Average Loss", fontsize=24)
		plt.yscale("log")
		...
		plt.savefig("./figures/final/convergence/resnet/%s_%s_%s_omega_%s_%s_%s_%s.pdf" % (n_agent_name,dataset,opt_name,omega,model_name,datashuffle, "graph_avg_loss"))
		plt.show()
...
'''
Example run:
/ocean/projects/cis200022p/shared/conda_pytorch_dist/bin/python plot_each_exp.py FC Ring Bipar -n_ag 5 -opt LGA_0.9 -d CIFAR10 -m CNN -u 300 -win 3 -ds non-iid -top 1 2
